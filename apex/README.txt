...
사선↔델타 간격(.brand__slash margin-right)은 수치로 맞추면 안 된다 — 글자 사이
최소 잉크 간격은 A→P .0875 / P→E .1025 / E→X .06em 이지만 그 값은 한 지점에서만
좁고 위로 벌어진다. 사선과 델타는 빗변이 평행해 채널이 캡높이 전체에 균일하므로
같은 수치라도 훨씬 넓어 보인다. 실제 렌더를 비교해 .028em 으로 잡았다.
